...
public class MainActivity extends Activity
{
    ...
    private void updateStandard()
    {
        ...
        double fifteenPercentTotal = (billAmount + fifteenPercentTip)/number;
    ...
    private void updateCustom()
    {
        ...
        double customTotal = (billAmount + customTip)/number;
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            ...
            if(number==0){
                new AlertDialog.Builder(MainActivity.this).setTitle("Error")
                        .setMessage("Please input correct number of people")
                        .setPositiveButton("OK",null).show();
                numberDisplayTextView.setText(String.valueOf("1"));


            }
            else {
                numberDisplayTextView.setText(String.valueOf(number));
                updateStandard();
                updateCustom();
            }
